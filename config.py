...
# stop_bot_time = os.environ["STOP_BOT_TIME"]
# bot_sqf_time = os.environ["SQF_TIME"]

# # Bot First Candle Time

# candle_fetch_time1 = os.environ["CANDLE_FETCH_TIME1"]
# candle_fetch_time2 = os.environ["CANDLE_FETCH_TIME2"]
